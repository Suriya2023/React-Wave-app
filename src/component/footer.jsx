      ...
      <section className="bg-light py-4 py-md-5 py-xl-8 border-top border-light">
        <div className="container overflow-hidden">
          <div className="row gy-4 gy-lg-0 justify-content-xl-between">
            ...
            <div className="col-12 col-md-4 col-lg-3 col-xl-2">
              <div className="widget">
                <h4 className="widget-title tw-my-5 tw-font-bold tw-text-2xl">Get in Touch</h4>
                <address className="mb-4  tw-font-gray">8014 Edith Blvd NE, Albuquerque, New York, United States</address>
                <p className="mb-1">
            ...
            <div className="col-12 col-md-4 col-lg-3 col-xl-2">
              <div className="widget">
                <h4 className="widget-title tw-my-5 tw-font-bold tw-text-2xl">Learn More</h4>
            ...
            <div className="col-12 col-lg-3 col-xl-4">
              <div className="widget">
                <h4 className="widget-title tw-my-5 tw-font-bold tw-text-2xl">Our Newsletter</h4>
            ...
            <div className="col-xs-12 col-md-7 order-1 order-md-0">
              ...
              <div className="credits text-secondary text-center text-md-start mt-2 fs-7">
                Built by <a href="https://bootstrapbrain.com/"
                  className="link-secondary text-decoration-none">BootstrapBrain</a> with <span
