...
function Pricing() {
  return (
    <div>
       <section id="scrollspyPricing"
      className="bsb-pricing-1 bsb-tpl-bg-sea-shell py-5 py-xl-8 bsb-section-py-xxl-1 tw-bg-yellow-50">
      <div className="container">
        <div className="row gy-5 gy-lg-0 align-items-center">
          <div className="col-12 col-lg-4">
            <h2 className="display-3 tw-font-bold mb-4">Our <span className=""><span
                  className="bsb-tpl-font-hw display-1 text-accent fw-normal">Pricing</span></span></h2>
            <p className="fs-4 mb-4 mb-xl-5">Explore our flexible pricing to find an excellent fit to run your business.</p>
            <a href="#!" className="btn bsb-btn-4xl btn-primary rounded-pill tw-p-4 tw-text-2xl">More Plans</a>
          </div>
                  ...
                  <div className="col-12 col-md-6">
                    <div className="card border-0 border-bottom border-primary shadow-sm">
                      <div className="card-body p-4 p-xxl-5">
                        ...
                        <a href="#!" className="btn bsb-btn-4xl btn-danger rounded-pill tw-p-4 tw-text-2xl">Choose Plans</a>
