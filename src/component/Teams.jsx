      ...
      <div className="container mb-5 mb-md-6 mb-xl-10">
        <div className="row justify-content-md-center">
          <div className="col-12 col-md-10 col-lg-9 col-xl-8 col-xxl-7 text-center">
            <h2 className="display-3 fw-bolder mb-4">We are a group of <br/><span className=""><span
                  className="bsb-tpl-font-hw display-1 text-accent fw-normal">innovative</span></span>, experienced, and
              proficient teams.</h2>
          </div>
        </div>
      </div>
