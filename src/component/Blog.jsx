...
function Blog() {
  return (
    <div>
       <section id="scrollspyBlog" className="bsb-tpl-bg-linen  tw-bg-yellow-50 py-5 py-xl-8 bsb-section-py-xxl-1 ">
      <div className="container">
        <div className="row gy-5 gy-lg-0 align-items-center">
          <div className="col-12 col-lg-4">
            <h2 className="display-3 fw-bolder mb-4">Our <span className=""><span
                  className="bsb-tpl-font-hw display-1 text-accent fw-normal">Blog</span></span></h2>
